...
[00_MASTER_KOREA_VIETNAM.md](./00_MASTER_KOREA_VIETNAM.md) là bản tổng quan dài về KRX/KOSPI/KOSDAQ, ETF/ETN Hàn Quốc, KRW/BOK, HOSE/HNX/UPCoM, VN30 futures, banking, property, FDI, SBV và FTSE reclassification.

[01_KOREA_MARKET_PLAYBOOK.md](./01_KOREA_MARKET_PLAYBOOK.md) tập trung vào Korean market structure, exports, semiconductor, autos, banks, oil, China, Fed, BOK, KRW và foreign flows.

[02_VIETNAM_MARKET_PLAYBOOK.md](./02_VIETNAM_MARKET_PLAYBOOK.md) tập trung vào HOSE/HNX/UPCoM, daily price limits, domestic liquidity, banks, property, securities companies, VND/SBV, FDI, public investment và VN30 derivatives.

[03_CROSS_MARKET_GLOBAL_SHOCKS.md](./03_CROSS_MARKET_GLOBAL_SHOCKS.md) dùng cùng một framework để so tác động của Fed shock, China slowdown, oil shock, AI/semiconductor cycle, recession, trade war và geopolitical fragmentation lên Hàn Quốc và Việt Nam.
