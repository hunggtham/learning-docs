...
Với institutional Forex, cần tách `spot direction` khỏi `funding/hedging economics`: forward points, NDF, basis, collateral, reserve/intervention regime và hedge roll có thể đổi economics dù chart spot nhìn tương tự. Đồng thời phải đánh giá hedge theo **underlying exposure + derivative + funding/carry + residual risk**, không dùng standalone derivative P/L làm verdict.

## Bài tập tích hợp

Nếu đang học riêng Forex, hoàn thành [Forex Practice Labs](./forex/90_labs/README.md), đọc [Forex Historical Case Studies](./forex/80_case_studies/README.md), các [Institutional Connections](./forex/90_connections/), [Institutional Hedging Cases](./forex/60_institutional_hedging_cases/README.md) và đi qua [Systematic FX Implementation Project](./forex/70_systematic_project/README.md) trước hoặc song song với Module 5. Các lớp này lần lượt kiểm tra khả năng tự tính/explain, stress mental model dưới regime cực đoan, hiểu funding/policy mechanics, áp dụng hedge vào balance sheet và biến research thành process point-in-time/execution-aware có risk controls.
