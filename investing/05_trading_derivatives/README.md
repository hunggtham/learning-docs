...
Nếu đang học riêng Forex, hoàn thành [Forex Practice Labs](./forex/90_labs/README.md), đọc [Forex Historical Case Studies](./forex/80_case_studies/README.md) và đi qua [Systematic FX Implementation Project](./forex/70_systematic_project/README.md) trước hoặc song song với Module 5. Ba lớp này lần lượt kiểm tra khả năng tự tính/explain, stress mental model dưới regime cực đoan và biến research thành một process point-in-time/execution-aware có risk controls.
