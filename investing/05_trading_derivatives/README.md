...
Nếu đang học riêng Forex, hoàn thành [Forex Practice Labs](./forex/90_labs/README.md) và đọc [Forex Historical Case Studies](./forex/80_case_studies/README.md) trước hoặc song song với Module 5 để bảo đảm tự tính được exposure, event transmission, point-in-time backtest, portfolio risk và hiểu regime-break/funding stress.
