...
Domain này chuyển từ việc “biết đọc báo cáo” sang khả năng phân tích một doanh nghiệp như một hệ thống kinh tế. Bạn sẽ đi từ financial statements tới value chain, unit economics, moat, industry structure, valuation, earnings quality, modeling, forensic analysis, sector-specific frameworks và cuối cùng là governance/capital allocation.
...
[02_BUSINESS_QUALITY_MOAT_AND_INDUSTRY.md](./02_BUSINESS_QUALITY_MOAT_AND_INDUSTRY.md) đi từ business model và value-chain power tới revenue decomposition, contribution/unit economics, ROIC/incremental ROIC, cash conversion, network/switching/cost/brand/data/ecosystem moats, flywheel, pricing power, industry profit pool, rationality of competition, capacity/inventory cycles, cost curve, technology S-curve, moat erosion, disruption, reinvestment runway và optionality.
