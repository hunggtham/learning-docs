...
- [Computer Science Foundations Knowledge Library](computer_science/README.md): **100 topic chapters** theo conceptual dependency, từ computation/information, algorithms, architecture, OS, languages/runtime, database, Internet/distributed systems, security/reliability và software systems đến software engineering, AI foundations, HCI/graphics và computing ethics/society; có glossary Việt–Anh–Hàn, end-to-end connections và coverage audit.
...
- [Investing Knowledge Library](investing/README.md): bộ tài liệu đầu tư từ số 0 tới thực hành, gồm cổ phiếu, ETF, trái phiếu, vàng, Forex, futures/options, phân tích doanh nghiệp, kinh tế vi mô/vĩ mô chuyên sâu, kinh tế thế giới, dòng vốn quốc tế, thương mại, khủng hoảng tài chính, Fed, quản trị rủi ro, cùng thị trường Hàn Quốc và Việt Nam.
