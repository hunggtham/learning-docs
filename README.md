...
- [WebSquare JavaScript Knowledge Library](10_frontend/websquare/README.md): track frontend enterprise đặt trong `10_frontend/` thay vì tạo root mới; đi từ XML/W-Pack/runtime và component model đến `scwin`/`$p`/Scope/WFrame, DataCollection/Submission, GridView CRUD, SPA, debugging/performance/security, legacy-modern migration và coverage audit; cross-link JavaScript/XML canonical docs để tránh duplicate.
