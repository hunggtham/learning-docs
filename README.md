...
- [WebSquare JavaScript Knowledge Library](10_frontend/websquare/README.md): track frontend enterprise đặt trong `10_frontend/`; đi từ XML/W-Pack/runtime, component, `scwin`/`$p`/Scope/WFrame, DataCollection/Submission và GridView CRUD đến UDC/common architecture, validation/i18n/accessibility, lazy rendering/resource lifetime, testing/regression, W-Pack/config/deployment, debugging/performance/security và legacy-modern migration; cross-link JavaScript/XML canonical docs để tránh duplicate.
