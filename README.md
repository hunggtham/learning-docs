...
- [Computer Science Foundations Knowledge Library](computer_science/README.md): 59 chapter nền tảng tổ chức theo dependency từ computation/information, algorithms/data structures, architecture, OS và language/runtime đến database, networking/distributed systems, security/reliability và software systems; có glossary Việt–Anh–Hàn, end-to-end connections và coverage audit.
