...
neomeulsu	  	 	: {"ko":"{0}은(는) {1}자를 넘을수 없습니다. 현재 글자수({2}자)",
...
nonPayInfo				:{"ko":"결제여부를 알수 없습니다.",
						"en":"결제여부를 알수 없습니다.",
						"zh":"결제여부를 알수 없습니다."},

existPayInfo			:{"ko":"결제정보가 존재 합니다.",
						"en":"결제정보가 존재 합니다.",
						"zh":"결제정보가 존재 합니다."},

minPayAmount			:{"ko":"금액은 1,000원 이상부터 결제가 가능합니다.",
							"en":"금액은 1,000원 이상부터 결제가 가능합니다.",
							"zh":"금액은 1,000원 이상부터 결제가 가능합니다."}
