...
Ví dụ: **Cung Cảnh Phúc (경복궁 / Gyeongbokgung Palace)**. Tên có cách Hán–Việt tự nhiên hoặc quen thuộc được dịch, như **Cao Ly (고려 / Goryeo)**, **Bột Hải (발해 / Balhae)**, **Bình Nhưỡng (평양 / Pyongyang)**, **Đại vương Thế Tông (세종대왕 / King Sejong the Great)** và **Lý Thuấn Thần (이순신 / Yi Sun-sin)**.
