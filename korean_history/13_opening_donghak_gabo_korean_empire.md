...
> “Modernization” ở late nineteenth-century Korea là optimization dưới hostile constraints. Actor muốn cải cách nhưng không có quyền lựa chọn environment; mỗi policy move diễn ra trong board game mà các empire lớn cũng đang đi quân.

## Gunboat diplomacy và treaty asymmetry

Treaty port system tại East Asia không phải free-trade negotiation giữa equal states. Military pressure và extraterritorial privilege thay đổi sovereignty. Vì vậy economic opening và political coercion phải được phân tích cùng nhau.

## Reform sequencing problem

Modern army cần tax; tax reform cần administrative capacity; administrative reform cần trained officials; training cần school; school cần funding. Đây là dependency cycle. Late Joseon/Korean Empire không chỉ thiếu “ý chí cải cách”; sequencing reforms dưới foreign pressure là extremely difficult systems problem.

## Donghak từ religion tới mass organization

Donghak's doctrine về human dignity và opposition to corrupt order tạo language giúp local grievance connect thành broader movement. Organization network qua religious cells giảm coordination cost. Đây là historical example network structure ảnh hưởng capacity for collective action.

## Gabo reforms và social order

Abolition of formal status distinctions, reform of examination and administration cut deeply into Joseon institutional grammar. Nhưng law changing faster than practice means social behavior lagged. When schema migration occurs, old application logic can persist even after database definition changes.
