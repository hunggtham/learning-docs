...
UNESCO phân biệt di sản vật thể và **di sản văn hoá phi vật thể (무형유산 / intangible cultural heritage)**. Hàn Quốc có nhiều yếu tố được ghi danh như Pansori, Arirang, Kimjang, Nongak, Talchum, văn hoá Haenyeo Jeju và thực hành làm jang.

Một mô hình tư duy tốt là xem di sản như:

```text
vật thể / màn biểu diễn
+ kỹ năng truyền nghề
+ ý nghĩa cộng đồng
+ bối cảnh sử dụng
= di sản sống
...
**Pansori (판소리)** là nghệ thuật kể chuyện bằng giọng hát và lời nói được cách điệu, thường với một `소리꾼` và một người đánh trống `고수`. UNESCO mô tả truyền thống này như sự kết hợp nhiều lớp văn hoá, với màn biểu diễn có thể rất dài.

Từ `판` gợi nơi tụ họp/sân, `소리` là âm thanh/tiếng hát. Pansori không chỉ là giai điệu; nó là một **động cơ kể chuyện (narrative engine)**. Người hát thay giọng, nhịp độ, cử chỉ và âm sắc để tạo nhiều nhân vật và cảnh.

Trong xử lý tín hiệu, âm sắc phụ thuộc phổ hài và đường bao theo thời gian. Luyện pansori tạo chất giọng đặc biệt, đôi khi khàn và mạnh, nhưng ý nghĩa nghệ thuật không thể rút gọn thành biến âm học. Vật lý mô tả tín hiệu; văn hoá giải thích vì sao tín hiệu đó có ý nghĩa.
...
**Arirang (아리랑)** không phải một bài duy nhất có phiên bản chuẩn cố định. UNESCO nhấn mạnh đây là truyền thống dân ca được nhiều thế hệ tạo và tái tạo. Có nhiều biến thể vùng miền.

Chính sự đa dạng này quan trọng với bản sắc văn hoá. Một biểu tượng quốc gia không nhất thiết thống nhất bằng việc mọi phiên bản giống hệt nhau; nó có thể thống nhất nhờ **sự giống nhau theo họ (family resemblance)** giữa nhiều biến thể.
...
**Nongak (농악)** kết hợp bộ gõ, múa, diễu hành và nghi lễ, gắn với đời sống cộng đồng. Nhịp không chỉ để nghe; nó tổ chức chuyển động của nhóm trong không gian.

**Samulnori (사물놀이)** là dạng biểu diễn bộ gõ trên sân khấu hiện đại hơn, dùng bốn loại nhạc cụ chính và phát triển từ vốn nhịp điệu của truyền thống gõ dân gian. Người học thường đồng nhất samulnori với toàn bộ nongak, nhưng bối cảnh biểu diễn khác nhau.

Nongak có thể bao gồm chuyển động, diễu hành ngoài trời và nhóm lớn hơn; samulnori thường gọn và tập trung sân khấu hơn. Đây là ví dụ **định dạng lại (reformatting)**: truyền thống được đóng gói lại để phù hợp địa điểm và khán giả mới.
...
**Múa kịch mặt nạ (탈춤 / mask dance drama)** dùng mặt nạ, múa, nhạc và châm biếm. Mặt nạ tạo nghịch lý: che danh tính cá nhân nhưng mở khả năng nói điều thường khó nói. Châm biếm có thể nhắm giới tinh hoa, tăng lữ hoặc đạo đức giả xã hội.
...
**Âm nhạc nghi lễ tổ tiên hoàng gia (종묘제례악 / royal ancestral ritual music)** là phần của nghi lễ tại Jongmyo. Ở đây âm nhạc không nhằm giải trí độc lập; nó tổ chức thời gian, chuyển động và thứ bậc của nghi lễ.
...
Gốm Hàn cho thấy công nghệ và thẩm mỹ gắn nhau. **Thanh từ Cao Ly (고려청자 / Goryeo celadon)** nổi tiếng với men xanh và kỹ thuật khảm `상감`. **Bạch sứ Triều Tiên (조선백자 / Joseon white porcelain)** có thẩm mỹ khác, thường liên hệ với sự tiết chế của giới văn nhân Joseon.

Màu men là hoá học. Thành phần khoáng, hàm lượng sắt, môi trường lò và nhiệt độ ảnh hưởng trạng thái oxy hoá và tính quang học. Một vật đẹp là đầu ra của **khoa học vật liệu (material science)** trước khi thuật ngữ này tồn tại.
...
**Thư pháp (서예 / calligraphy)** biến viết chữ thành nghệ thuật thị giác. Áp lực bút, tốc độ, lượng mực và thứ tự nét tạo dấu vết chuyển động.

Một chữ có nội dung ngữ nghĩa nhưng thư pháp thêm lớp cơ thể. Hai người viết cùng chữ có thể tạo thẩm mỹ khác vì điều khiển vận động khác.
...
`옻칠` là kỹ thuật sơn dùng nhựa cây sơn qua nhiều bước xử lý và phủ lớp. Kết quả phụ thuộc vật liệu, độ ẩm, quá trình khô/đóng rắn và tay nghề.
...
Di sản phi vật thể tồn tại nhờ người biết làm. Vì vậy Hàn Quốc phát triển khung thiết chế để nhận diện người thực hành, nhóm và hệ truyền nghề.

Điểm đáng chú ý không phải danh hiệu hành chính cụ thể mà là bài toán thiết kế: nếu một kỹ năng cần 20 năm học nghề nhưng thị trường thương mại không trả đủ thu nhập, kỹ năng vẫn có thể mất dù bảo tàng còn giữ vật thể.
...
Nghệ sĩ hiện đại có thể kết hợp `가야금`, bộ gõ hoặc kỹ thuật thanh nhạc truyền thống với jazz, rock, nhạc điện tử và truyền thông thị giác. Có người xem đó là đổi mới, có người lo pha loãng.
...
```text
tri thức tường minh → sách, ký âm, lưu trữ
...
`아리랑` không phải chỉ một bản ghi chuẩn.

`사물놀이` không đồng nghĩa toàn bộ `농악`.
