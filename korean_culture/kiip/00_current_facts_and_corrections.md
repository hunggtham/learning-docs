...
Cách học:
- học **cơ chế/hệ thống**
- chỉ học số khi giáo trình/공지 hiện hành nhấn mạnh
- với chính sách đang thay đổi: kiểm tra `정부24`, `교육부`, `보건복지부`, `법무부`

## 7. Các fact tương đối ổn định trong bộ PDF

Những mục sau có tính cấu trúc cao và vẫn là nền tảng:
