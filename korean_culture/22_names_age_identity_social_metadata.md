...
Tên Hàn thường gồm họ **성 (surname / 성씨)** và tên riêng **이름 (given name)**. Nhiều họ chỉ có một âm tiết, trong khi tên riêng truyền thống thường gồm hai âm tiết, dù đời sống hiện đại có nhiều biến thể. Việc họ đứng trước tên riêng phản ánh một quy ước Đông Á rộng hơn, nơi bản sắc gia đình được đặt ngay đầu chuỗi định danh.

Điều quan trọng hơn cấu trúc tên là bối cảnh sử dụng. Trong môi trường trang trọng, gọi thẳng tên riêng của người lớn tuổi hơn hoặc người có chức vụ cao hơn có thể nghe quá trực tiếp. Người Hàn thường dùng **cách xưng hô (form of address / 호칭)** như `과장님`, `선생님`, `형`, `언니`, `어머님` để biểu diễn quan hệ thay vì chỉ gọi tên.
...
Một số dòng họ từng sử dụng **tên thế hệ (generation name / 항렬자)**, tức một chữ Hán hoặc âm tiết được dùng chung cho những người cùng thế hệ trong dòng họ. Hệ thống này cho phép nhìn vào tên và suy ra vị trí tương đối trong cây gia đình.
...
Trong lịch sử đời sống Hàn Quốc có nhiều cách tính tuổi. Ba khái niệm thường gặp là:

| Khái niệm | Korean | Cách tính |
|---|---|---|
| Tuổi đầy đủ/quốc tế | 만 나이 | tăng vào ngày sinh |
| Tuổi theo năm | 연 나이 | năm hiện tại trừ năm sinh |
| Tuổi đếm kiểu truyền thống | 세는나이 | sinh ra được tính 1 tuổi và cùng tăng vào đầu năm |
...
Giả sử A và B mới gặp. Cả hai cần chọn giữa nhiều cách nói. Nếu quá thân mật từ đầu, có rủi ro bất lịch sự; nếu giữ quá trang trọng quá lâu, quan hệ khó gần. Năm sinh cung cấp một tín hiệu để giảm bất định.
...
hỏi tuổi / năm sinh
      ↓
biết thứ tự tuổi tương đối
      ↓
chọn danh xưng + cấp độ lời nói
```
...
### “Người Hàn lúc nào cũng hỏi tuổi vì tò mò”

Nhiều khi câu hỏi có chức năng phối hợp hơn là tò mò. Nó giúp xác định cấp độ lời nói và loại quan hệ. Tuy nhiên trong môi trường quốc tế hoặc giữa người trẻ, việc hỏi tuổi ngay lập tức có thể ít cần thiết hơn trước.

### “Luật đổi sang 만 나이 thì văn hoá tuổi biến mất”

Luật có thể chuẩn hoá cách tính tuổi hành chính, nhưng thói quen văn hoá thay đổi theo tốc độ khác. Hai lớp không đồng bộ ngay.
