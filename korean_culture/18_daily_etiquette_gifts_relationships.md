...
Thực tế, **phép lịch sự (etiquette / 예절)** là cách xã hội biểu đạt sự tôn trọng, khoảng cách, quan tâm và tư cách thành viên qua hành vi. Cùng một động tác có thể cần thiết trong bối cảnh trang trọng nhưng lại không tự nhiên giữa bạn thân. Vì vậy câu hỏi quan trọng không chỉ là “quy tắc là gì?” mà là **quy tắc này đang mã hoá loại quan hệ nào?**

Có thể phân tích qua bốn biến:

```text
khoảng cách quan hệ
+ thứ bậc
+ mức trang trọng của bối cảnh
+ kỳ vọng có đi có lại
→ hành vi phù hợp
```
...
**Chào hỏi (greeting / 인사)** rất quan trọng trong nhiều môi trường Hàn Quốc. Cúi đầu nhẹ có thể đi cùng `안녕하세요`; trong công việc có thể kết hợp bắt tay. Không cần tính độ sâu cúi như một góc hình học cố định; mức trang trọng và quan hệ quyết định.

Điều quan trọng hơn là sự ghi nhận. Không chào người thường xuyên gặp trong văn phòng có thể bị hiểu là lạnh nhạt hoặc thiếu phép lịch sự vì lời chào xác nhận quan hệ mỗi ngày.

Trong hệ thống phân tán, tín hiệu nhịp tim (heartbeat) cho biết một nút vẫn hoạt động. Lời chào hằng ngày có chức năng xã hội gần tương tự: chi phí thấp nhưng duy trì trạng thái kết nối.
...
`약속 시간` không chỉ là việc xếp lịch. Đến muộn khiến người khác phải chịu bất định và chi phí chờ đợi. Trong công việc, đúng giờ thường được coi trọng; nếu chậm, báo sớm thường tốt hơn xuất hiện muộn mà không giải thích.

Câu `10분 정도 늦을 것 같습니다. 죄송합니다.` làm ba việc: báo sẽ chậm, ước lượng thời gian và thừa nhận sự bất tiện gây ra.
...
**Văn hoá quà tặng (gift-giving / 선물 문화)** xuất hiện trong ngày lễ, đi thăm, công việc, thăm bệnh và các mốc vòng đời. Bộ quà dịp `설날` hoặc `추석`, hộp trái cây, thực phẩm bổ sung hoặc phiếu cà phê là những hình thức khác nhau.

Một món quà có thể giải ba bài toán: thể hiện sự quan tâm, tạo tính có đi có lại và giảm lúng túng khi không biết nên nói gì. Tuy nhiên quà tặng cũng chịu giới hạn pháp lý trong một số bối cảnh công vụ; vì vậy “văn hoá quà tặng” không nằm ngoài luật.
...
**Tân gia (housewarming / 집들이)** là dịp mời bạn bè hoặc đồng nghiệp tới nhà mới. Quà truyền thống từng có giấy vệ sinh hoặc chất tẩy rửa với lời chúc biểu tượng kiểu “mọi việc trôi chảy”, nhưng hiện nay quà thực dụng, cây, đồ ăn hoặc quà số cũng phổ biến.

Quan trọng hơn món quà là ranh giới không gian. Nhà ở, đặc biệt căn hộ nhỏ, là không gian riêng tư. Được mời vào nhà có thể biểu thị mức thân mật cao hơn gặp nhau ở quán cà phê.
...
`경조사` là tên chung cho các sự kiện vui và buồn quan trọng như cưới và tang. Đây là nơi mạng xã hội ngoài đời trở nên nhìn thấy: đồng nghiệp, bạn học, họ hàng và đối tác cùng xuất hiện.

`축의금` là tiền mừng cho sự kiện vui, đặc biệt là đám cưới. `부의금` hoặc `조의금` liên quan tiền phúng viếng. Không có một “bảng giá văn hoá” áp dụng toàn quốc; số tiền phụ thuộc mức quan hệ, tiền lệ, chuẩn của nhóm và hoàn cảnh.
...
Trong tiếng Hàn, `친구` theo cách dùng truyền thống thường ngầm chỉ người cùng hoặc gần tuổi, dù hiện nay cách dùng linh hoạt hơn. Người lớn hơn hoặc nhỏ hơn nhưng thân có thể được gọi bằng từ thân tộc mở rộng hoặc từ chỉ quan hệ khác thay vì `친구` theo nghĩa hẹp.

Đây là ví dụ về **lệch ngữ nghĩa (semantic mismatch)**. “Friend” trong tiếng Anh chủ yếu mã hoá mức thân; hệ thống gọi trong tiếng Hàn truyền thống còn mã hoá cả quan hệ tuổi.

Một số nhãn quan hệ khác:

- `지인`: người quen.
- `아는 사람`: người mình biết.
- `동료`: đồng nghiệp, người cùng làm việc.
- `선배·후배`: người vào trước–vào sau.
- `동기`: người cùng khoá hoặc cùng đợt.
- `절친`: bạn rất thân.
...
**Buổi hẹn được giới thiệu (blind date / 소개팅)** là cuộc gặp qua bạn bè hoặc người quen, phổ biến như một kênh hẹn hò. `미팅` trong một số cách dùng lịch sử có thể chỉ cuộc gặp nhóm nam–nữ, đặc biệt trong văn hoá đại học.

Người giới thiệu đóng vai trò cầu nối niềm tin. Trong lý thuyết mạng, liên kết “bạn của bạn” làm mức bất định thấp hơn người hoàn toàn xa lạ. Ứng dụng hẹn hò làm việc ghép đôi mang tính thuật toán hơn, nhưng giới thiệu xã hội vẫn có giá trị vì lời giới thiệu chứa thông tin danh tiếng.
...
Khái niệm này đáng chú ý vì nó đặt tên cho **trạng thái mơ hồ (ambiguous state)**. Khi trạng thái có tên, người ta có thể thảo luận quy tắc của nó. Trong máy trạng thái phần mềm, việc đặt tên trạng thái cũng giúp quản lý chuyển đổi rõ hơn.
...
Chuẩn hẹn hò hoặc công việc truyền thống có thể để người lớn tuổi hơn hoặc người mời trả nhiều hơn. Nhưng **chia tiền (Dutch pay / 더치페이)**, chia hoá đơn và luân phiên trả ngày càng bình thường trong nhiều nhóm ngang hàng.

Cách trả tiền là thương lượng giữa bình đẳng, hiếu khách và thu nhập. Không nên giả định “ở Hàn đàn ông phải trả” hoặc “người lớn tuổi luôn trả”; bối cảnh và thế hệ rất quan trọng.
...
`읽씹` là đọc tin nhưng không trả lời; `안읽씹` thường chỉ để tin ở trạng thái chưa đọc hoặc không mở trong thời gian dài. Những từ này tồn tại vì nền tảng làm trạng thái tin nhắn quan sát được.

Trước khi có thông báo đã đọc, người gửi không biết tin đã được xem chưa. Sau khi trạng thái đọc được hiển thị, sự im lặng trở thành tín hiệu mạnh hơn. Đây là nơi văn hoá và thiết kế sản phẩm gặp nhau.
...
Trong tàu điện, thang máy, hàng chờ, nhà hàng hoặc quán cà phê, phép lịch sự không chủ yếu mã hoá sự thân mật mà giảm **chi phí cùng tồn tại (coexistence cost)**. Không chắn cửa, xếp hàng, giữ âm lượng phù hợp, nhường ghế ưu tiên khi cần và phân loại rác đúng quy định đều giúp người lạ chia sẻ hạ tầng.

Loại quy tắc này gần giao thức giao thông hơn nghi lễ gia đình: mục tiêu là tăng thông lượng và giảm tác động ngoại biên.
...
“Luôn phải dùng hai tay với mọi người” là quy tắc quá cứng.

`오빠` không đơn giản có nghĩa “boyfriend”.

“`소개팅` nghĩa là người Hàn không tự hẹn hò” là sai; đó chỉ là một kênh ghép đôi.

“Văn hoá quà tặng đồng nghĩa hối lộ” là nhầm phạm trù; ranh giới pháp lý và đạo đức phụ thuộc bối cảnh và giá trị món quà.
