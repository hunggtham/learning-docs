...
Ở Hàn Quốc, phòng khám chuyên khoa xuất hiện dày ở đô thị và người dân quen với các tên như `내과`, `이비인후과`, `피부과`, `정형외과`, `안과`, `치과`. Khi ma sát về đặt lịch, chi phí và tiếp cận tương đối thấp, ngưỡng đi khám cho triệu chứng nhẹ có thể thấp hơn ở xã hội nơi đặt lịch chăm sóc ban đầu khó hơn.

Bài học quan trọng là:

> **Mức sử dụng y tế không chỉ phản ánh mức độ nặng của bệnh.**
...
Một lần khám thường có luồng:

```text
접수: đăng ký
→ 대기: chờ
→ 진료: khám
→ 검사/처치: xét nghiệm / xử trí nếu cần
→ 수납: thanh toán
→ 처방전: đơn thuốc
→ 약국: nhà thuốc
```
...
`건강검진` — khám/sàng lọc sức khoẻ — là một phần dễ thấy của văn hoá phòng bệnh ở Hàn Quốc. Sàng lọc tìm nguy cơ hoặc bệnh ở người chưa nhất thiết có triệu chứng.

Điểm quan trọng về xác suất: ngay cả xét nghiệm tốt vẫn có thể tạo dương tính giả nếu tỷ lệ bệnh nền thấp.
...
Phòng nha `치과` là phần quen thuộc của y tế hằng ngày. Cạo vôi, điều trị sâu răng, chỉnh nha và implant có cả lớp y khoa lẫn thẩm mỹ.
...
`피부과` có thể điều trị bệnh da và cũng cung cấp thủ thuật thẩm mỹ. Người tiêu dùng dễ trộn điều trị y khoa với bảo trì ngoại hình.

Phân biệt cốt lõi:

```text
chỉ định y khoa → điều trị bệnh / rủi ro
mục tiêu thẩm mỹ → thay đổi ngoại hình theo sở thích
```
...
`한의학` có vị trí thiết chế riêng với phòng khám `한의원`. Người dân có thể dùng châm cứu, cứu ngải hoặc chế phẩm thảo dược cho một số vấn đề.

Tính chính danh văn hoá và hiệu quả khoa học là hai câu hỏi khác nhau. Một thực hành có lịch sử lâu không chứng minh mọi tuyên bố; ngược lại ý nghĩa văn hoá của nó cũng không biến mất chỉ vì bằng chứng cho một chỉ định cụ thể còn yếu.

Đánh giá khoa học cần:

- nhóm đối chứng hoặc phương pháp so sánh;
- mức độ hiệu quả;
- khả năng lặp lại;
- tác dụng bất lợi;
- chi phí cơ hội.
...
Ba câu hỏi phải tách:

1. bệnh nhân cảm thấy gì?
2. can thiệp có hiệu quả vượt nhóm đối chứng không?
...
`보약`, vitamin, probiotic, hồng sâm, collagen, omega-3 và thực phẩm chức năng tồn tại trong thị trường nơi kết quả dài hạn khó tự quan sát.

Quảng cáo vì vậy thường dùng các chỉ báo như `면역`, `활력`, `피로`, `항산화`, `장 건강`. Người tiêu dùng nên hỏi:

```text
cơ chế?
liều?
có thiếu hụt nền hay không?
chất lượng bằng chứng?
mức hiệu quả tuyệt đối?
tương tác?
```
...
Một sản phẩm có thể có hai lớp giá trị:

```text
giá trị sinh học + giá trị quan hệ
```
...
Diễn ngôn sức khoẻ tinh thần ở Hàn Quốc dễ thấy hơn qua truyền thông, công sở và thảo luận của giới trẻ. Các từ `우울증`, `불안`, `번아웃`, `상담`, `정신건강의학과` ngày càng quen.

Nhưng kỳ thị không biến mất đồng đều. Một số người vẫn ngại nhãn tâm thần vì lo danh tiếng hoặc hiểu sai về hồ sơ điều trị.

Cần tách:

`stress` ≠ rối loạn lâm sàng,  
...
Làm việc quá sức, đi làm xa và nghĩa vụ xã hội sau giờ làm có thể ảnh hưởng ngủ, vận động và giờ ăn. Kết quả sức khoẻ không chỉ là “ý chí cá nhân”.

Chuỗi hệ thống:

```text
làm việc / đi lại dài
→ ngân sách ngủ / thời gian giảm
→ vận động / bữa ăn thất thường
→ hồi phục căng thẳng kém
→ triệu chứng tăng
```
...
Nhân viên văn phòng thường nói `거북목`, cứng cổ/vai và mỏi mắt. Đây là từ vựng đời sống quanh công việc ngồi lâu với màn hình.
...
Núi/đường mòn gần giao thông đô thị làm giảm chi phí giao dịch của đi bộ và leo núi. Môi trường vì vậy có thể tạo điều kiện ở quy mô dân số cho vận động.

Xác suất hành vi thường tăng khi ma sát giảm:

```text
đường mòn gần + xe buýt/tàu điện + biển chỉ dẫn
...
`미세먼지`, `초미세먼지` được kiểm tra gần giống thời tiết. Ứng dụng chất lượng không khí, khẩu trang và máy lọc làm khoa học môi trường đi vào thói quen gia đình.

Hạt PM2.5 nhỏ có thể đi sâu vào đường hô hấp. Phản ứng văn hoá là **thích nghi dựa trên thông tin**:

```text
cảm biến / báo cáo
→ cảm nhận rủi ro
→ quyết định khẩu trang / mở cửa / tập ngoài trời
→ nhu cầu máy lọc
```
...
Nắng nóng, mùa hè ẩm và mùa đông lạnh ảnh hưởng uống nước, sưởi/làm mát, vận động ngoài trời và rủi ro với người cao tuổi. Điều hoà, ondol, trung tâm tránh nóng công cộng và cảnh báo thời tiết là hạ tầng sức khoẻ xã hội.
...
Khi đọc tuyên bố sức khoẻ trực tuyến, cần hỏi:

- chuyên môn của nguồn;
- xung đột lợi ích;
- thiết kế nghiên cứu;
- cỡ mẫu;
- rủi ro tương đối và tuyệt đối;
- kết quả có áp dụng được cho bản thân hay không.
...
Da liễu, thủ thuật thẩm mỹ và khám sức khoẻ thu hút khách nước ngoài ở một số phân khúc. Hallyu/K-beauty có thể tạo hiệu ứng lan toả thương hiệu.
...
“Y học truyền thống và y sinh chỉ là hai niềm tin ngang nhau” không đúng khi đánh giá hiệu quả thực nghiệm cụ thể.

“Đổ mồ hôi trong sauna = thải độc” là tuyên bố quá mức.

“Sàng lọc sức khoẻ càng nhiều càng tốt” bỏ qua dương tính giả, chẩn đoán quá mức và xét nghiệm nối tiếp.

“Bệnh viện nhiều sao = chất lượng lâm sàng cao” trộn trải nghiệm dịch vụ với kết quả y khoa.
