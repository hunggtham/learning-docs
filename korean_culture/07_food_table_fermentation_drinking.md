...
Một bữa Hàn truyền thống thường được cấu trúc quanh cơm, canh và nhiều **món phụ (반찬 / side dishes)**. Nhưng “truyền thống” không có nghĩa bất biến. Số món, nguyên liệu và cách phục vụ thay đổi theo tầng lớp, vùng, mùa và thời đại.
...
Trong quá khứ, **soban (소반)** — bàn nhỏ cá nhân — từng phổ biến. Tư liệu Korea.net ghi nhận người cao tuổi hoặc địa vị cao có thể dùng bàn riêng, và vị trí ngồi chịu ảnh hưởng của tuổi, giới và địa vị. Điều này nhắc ta rằng hình ảnh “mọi người Hàn từ xưa ăn chung một bàn đầy banchan” là cách tái dựng hiện đại hơn nhiều người tưởng.
...
Nhiều thực đơn định lượng theo `인분` — suất cho một người. Một số món như thịt nướng hoặc lẩu có thể yêu cầu gọi tối thiểu theo số phần, đặc biệt nếu bàn dùng chung bếp.

`2인분 주세요` nghĩa “cho hai phần”. Nhưng một phần không phải chuẩn calo cố định; nó là đơn vị thương mại của nhà hàng. Vì vậy người mới sống ở Hàn không nên ánh xạ máy móc `1인분 = một người chắc chắn ăn đủ`.
...
**Kimchi (김치)** là nhóm rau được bảo quản bằng muối, gia vị và **lên men (fermentation)**, có nhiều loại theo nguyên liệu, vùng và mùa. Baechu kimchi chỉ là một dạng nổi tiếng.

Lên men là nơi văn hoá gặp vi sinh học. Vi khuẩn axit lactic chuyển carbohydrate thành axit, làm pH giảm và ức chế nhiều vi sinh vật gây hỏng. Có thể hình dung quá trình axit hoá bằng:

```math
pH=-\log_{10}[H^+]
```

Logarit nén khoảng nồng độ rất rộng thành thang dễ dùng. Mỗi giảm 1 đơn vị pH tương ứng `[H+]` tăng 10 lần. Trong kimchi, ta không “tính pH để nấu ăn” hằng ngày, nhưng hoá học giải thích vì sao nhiệt độ, muối và thời gian làm kết cấu và hương vị thay đổi.
...
`된장`, `간장`, `고추장` thuộc nhóm **장 (jang)**, các gia vị lên men nền tảng. Quá trình truyền thống liên quan `메주`, khối đậu nành lên men, rồi ngâm muối và ủ chín.
...
**Ăn một mình (혼밥)** từng mang kỳ thị trong một số bối cảnh coi trọng nhóm, nhưng hộ một người, lịch bận và hình thức nhà hàng đã làm nó bình thường hơn nhiều.

Thị trường thích nghi bằng ghế quầy, lẩu một người, suất tiện lợi, giao hàng và bao bì nhỏ. Đây là liên hệ trực tiếp với cấu trúc hộ: khi quy mô hộ giảm, kiến trúc dịch vụ ăn uống cũng đổi.
...
Phép tắc truyền thống khi uống với người lớn gồm dùng hai tay khi rót/nhận và quay đầu nhẹ khi uống. Những cử chỉ này mã hoá sự kính trọng. Nhưng mức nghiêm thay đổi theo nhóm.
...
Hàn Quốc có hệ sinh thái giao đồ ăn phát triển nhờ mật độ đô thị, điện thoại thông minh, hạ tầng thanh toán và logistics. `치맥` giao tận nhà, `배달앱`, suất cửa hàng tiện lợi và đồ ăn đêm làm nhịp bữa ăn linh hoạt hơn.

Nền tảng số biến văn hoá ăn uống thành bài toán tối ưu: thời gian giao dự kiến, ghép tài xế, xếp hạng nhà hàng và gợi ý đều dùng thuật toán. Món “truyền thống” giờ đi qua hạ tầng đám mây, GPS và hệ thống gợi ý trước khi tới bàn.
...
“Kimchi là cabbage kimchi” quá hẹp; kimchi là cả một nhóm thực phẩm.

“Người Hàn lúc nào cũng ăn chung” không còn đúng trong xã hội `혼밥`, hộ một người và giao hàng.
