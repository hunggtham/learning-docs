...
> Khi chi phí, lợi ích và lựa chọn sẵn có của một tập quán thay đổi đủ mạnh, giá trị biểu tượng có thể còn nhưng cách thực hiện sẽ bị thương lượng lại.
...
Theo `2025 고령자 통계` của cơ quan thống kê Hàn Quốc, người từ 65 tuổi trở lên chiếm khoảng **20,3% dân số năm 2025**. Mốc 20% thường được dùng để mô tả **xã hội siêu già (초고령사회 / super-aged society)**.

Già hoá ảnh hưởng nhiều hệ thống con cùng lúc:

```text
nhiều người cao tuổi
→ nhu cầu y tế tăng
→ nhu cầu lao động chăm sóc tăng
→ áp lực lương hưu tăng
→ gánh nặng chăm sóc của hộ gia đình thay đổi
→ nhà ở / khả năng tiếp cận phải thích nghi
→ nguồn cung lao động và chính sách hưu trí chịu áp lực
```
...
Điều quan trọng hơn con số là **mô hình nhân quả (causal model)**. Quyết định sinh con nằm trong nhiều ràng buộc: khả năng chi trả nhà ở, độ ổn định việc làm, gián đoạn sự nghiệp, khả năng tiếp cận chăm trẻ, phân chia lao động không lương, kỳ vọng giáo dục, thời điểm kết hôn và cảm nhận về an toàn tương lai.

Có thể hình dung — đây không phải mô hình chính thức:
...
```text
giáo dục kéo dài
→ vào việc chính thức muộn
→ hình thành nhà ở riêng muộn
→ kết hôn muộn
→ sinh con đầu muộn
→ cửa sổ sinh học / thời gian hẹp hơn
```
...
Trong mô hình đời sống cũ, tuổi trưởng thành thường được kể theo tuyến:
...
`혼밥` và `혼술` cho thấy văn hoá có thể thay mà không cần chiến dịch chính thức. Khi nhiều người sống một mình, lịch sinh hoạt khác nhau và thiết kế nhà hàng thay đổi, tiêu dùng một mình trở nên bình thường.

Doanh nghiệp thích nghi bằng ghế quầy, phần ăn một người và giao hàng. Sau đó chính môi trường mới lại làm hoạt động một mình dễ hơn:
...
Các nhãn như `X세대`, `MZ세대`, `586세대` có thể hữu ích nếu chỉ rõ trải nghiệm lịch sử chung. Người lớn lên thời tương tự, khủng hoảng IMF, mở rộng băng rộng hay thời điện thoại thông minh có hệ tham chiếu khác nhau.

Nhưng thế hệ không xoá khác biệt về thu nhập, giới, vùng, giáo dục và nền tảng gia đình. Nếu mọi hành vi được giải thích bằng `MZ`, mô hình quá thô.

Một cách tốt hơn là tách:

```text
hiệu ứng nhóm thế hệ (cohort effect) = trải nghiệm lịch sử chung
hiệu ứng tuổi (age effect) = tác động của giai đoạn vòng đời
hiệu ứng thời kỳ (period effect) = sự kiện tác động nhiều lứa tuổi cùng lúc
```
...
`이민자2세` = thế hệ thứ hai theo phân loại thống kê liên quan.  
`이주배경인구` = nhóm bao trùm rộng hơn.
...
Di cư đến Hàn Quốc qua nhiều kênh: lao động, du học, kết hôn, việc làm chuyên môn, thường trú và người gốc Hàn trở về.
...
Sinh viên quốc tế làm tăng đa dạng trong trường đại học và kinh tế địa phương. Nhưng hội nhập không tự động xảy ra chỉ vì học chung trường. Năng lực ngôn ngữ, nhà ở, visa, việc làm bán thời gian, mạng quan hệ và thiết kế lớp học quyết định họ có thật sự đi vào mạng xã hội chung hay chỉ tồn tại như nhóm song song.
...
Giáo dục và việc làm của phụ nữ tăng mạnh nhưng lao động chăm sóc không lương không tự động được phân phối lại cùng tốc độ. Nếu công sở vẫn giả định “người lao động lý tưởng” luôn sẵn sàng, trong khi hộ gia đình cần chăm trẻ/người cao tuổi, cặp vợ chồng cùng đi làm gặp **xung đột thời gian (time conflict)**.

```text
kỳ vọng công việc cao
+ nhu cầu chăm sóc cao
+ thời gian hữu hạn
= căng thẳng / gián đoạn sự nghiệp / chi phí sinh con
```
...
Năm 2024, khoảng **76,9% người từ 65 tuổi trở lên sử dụng Internet**, và mức sử dụng trình nhắn tin tức thời trong nhóm này rất cao theo `2025 고령자 통계`.
...
`지방소멸` là thuật ngữ chính sách về rủi ro suy giảm dân số địa phương. Nó không có nghĩa một thành phố sẽ biến mất theo nghĩa đen trong ngày mai.

```text
ít việc làm
→ người trẻ rời đi
→ trường học / cơ sở khách hàng giảm
→ dịch vụ giảm
→ doanh nghiệp khó tuyển
→ việc làm càng ít
```
...
Hộ gia đình nhỏ và kết hôn muộn làm ngành thú cưng nổi bật hơn. `반려동물` thay cho cách nhìn con vật như tài sản đơn thuần, nhấn mạnh quan hệ đồng hành.
...
Dòng chảy không còn chỉ là `Korea → world` mà là:
...
`1인가구 = thanh niên độc thân` bỏ qua người cao tuổi, người ly hôn, người sống xa gia đình vì công việc và người goá.

“Hàn Quốc vẫn hoàn toàn đồng nhất” ngày càng không phù hợp với thực tế dân số.

“Người nước ngoài cư trú, dân số có nền tảng di cư và người nhập quốc tịch là cùng một thống kê” là sai về phân loại.
...
- `2025년 이민자체류실태및고용조사`, công bố 10/03/2026: người nước ngoài cư trú trong phạm vi khảo sát khoảng 1,692 triệu tại tháng 5/2025. Nguồn: 국가데이터처/Statistics Korea.
