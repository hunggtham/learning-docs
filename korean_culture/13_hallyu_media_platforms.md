...
```text
người sáng tạo
→ studio / công ty giải trí / nhà xuất bản
→ nền tảng / đài / nhà phát hành
→ tìm kiếm / đề xuất / quảng bá
→ người xem / người hâm mộ
...
Nó gần với một **đơn vị tích hợp hệ thống (systems integrator)** hơn là một người quản lý cá nhân. Một đợt comeback cần nhạc sĩ, người viết lời, biên đạo, vũ công, stylist, nhiếp ảnh gia, đội video, dựng phim, PR, phân phối và nhân sự sân khấu cùng hoàn thành đúng thời điểm.
...
`데뷔` là ra mắt. `컴백` trong K-pop thường chỉ một chu kỳ phát hành và quảng bá mới, không nhất thiết mang nghĩa “trở lại sau thời gian dài” như trong tiếng Anh thông thường.
...
→ lịch teaser
→ phát hành
→ streaming / bình chọn / chương trình âm nhạc
...
→
chức năng mới: sưu tầm + trưng bày + ủng hộ + tham gia sự kiện + trao đổi
```
...
Fandom K-pop có đội dịch, hướng dẫn streaming, quyên góp, dự án sinh nhật, mua quảng cáo và quản trị cộng đồng. Không có một người điều khiển toàn bộ, nhưng mục tiêu chung, hashtag, bảng tính và công cụ nền tảng có thể tạo hành động tập thể.

Đây là **phối hợp phân tán (distributed coordination / 분산 협업)**. Nó có điểm giống cộng đồng mã nguồn mở: quy tắc không hoàn toàn tập trung, người tham gia tự chia việc và xung đột về ưu tiên vẫn có thể xảy ra.

Một số từ cho thấy fandom có “trạng thái” riêng:

- `최애`: thành viên hoặc nghệ sĩ yêu thích nhất;
- `입덕`: bước vào fandom;
- `덕질`: hoạt động của fan;
- `탈덕`: rời fandom.
...
**Quan hệ cận xã hội (parasocial relationship / 준사회적 관계)** là cảm giác gần gũi với nhân vật truyền thông dù quan hệ không cân xứng như tình bạn riêng tư hai chiều.

```text
cảm giác gần gũi cao
≠
quan hệ cá nhân tương hỗ đầy đủ
```
...
YouTube, TikTok, Spotify và nền tảng video ngắn quyết định một phần việc nội dung nào được đề xuất. Nội dung có tỷ lệ xem tiếp cao, phát lại nhiều hoặc tương tác mạnh có thể được đưa tới nhiều người hơn.
...
Bảng xếp hạng và số lượt nghe giúp đo mức chú ý, nhưng chỉ số không đồng nhất với chất lượng nghệ thuật. Khi thứ hạng có uy tín, fandom có động lực tối ưu streaming và bình chọn.

```text
chỉ số đo độ phổ biến
...
Truyền hình truyền thống tạo `편성`, tức lịch cố định. Streaming cho người xem chọn thời gian, thiết bị và tốc độ xem.

```text
phát sóng cố định
→ hộ gia đình đồng bộ theo lịch đài

xem theo yêu cầu
→ cá nhân tự chọn thời gian
```
...
`예능` — chương trình giải trí — cho thấy tài sản trí tuệ có thể nằm trong **định dạng (format)** chứ không chỉ trong tập phim cuối. Một định dạng có thể được mua quyền và làm lại với dàn cast địa phương.
...
`웹소설` — tiểu thuyết web — có chi phí sản xuất thấp hơn phim người đóng. Phản hồi sớm của độc giả giúp nhà xuất bản nhìn thấy nhu cầu trước khi đầu tư vào chuyển thể đắt tiền.

```text
tiểu thuyết web
→ webtoon
→ phim / trò chơi
→ hàng lưu niệm / thương hiệu nội dung
```
...
Phát trực tiếp trò chơi tạo một đường mới giữa người chơi và người xem. Streamer có thể xây cộng đồng, nhận doanh thu đăng ký hoặc tài trợ và ảnh hưởng việc khán giả khám phá trò chơi.
...
Khán giả dễ nhớ diễn viên, ca sĩ hoặc đạo diễn, nhưng một sản phẩm truyền thông còn phụ thuộc biên kịch, trợ lý biên kịch, hoạ sĩ, trợ lý vẽ, biên tập viên, vũ công, biên đạo, dựng phim, thiết kế âm thanh, dịch giả, phụ đề, stylist, nhân viên sân khấu, quản lý sản xuất và nhiều vị trí khác.

Đây là vấn đề **khả năng nhìn thấy lao động (labour visibility)**. Lao động gần mặt tiền thương hiệu dễ được nhận biết; lao động hậu trường có thể ảnh hưởng mạnh đến chất lượng nhưng ít tích luỹ danh tiếng công chúng.

```text
khả năng nhìn thấy cao
≠
mức đóng góp cao hơn tuyệt đối
```
...
Webtoon hoặc nội dung phát hành theo lịch đều có thời hạn lặp. Khi khán giả kỳ vọng tập mới đúng ngày, áp lực lịch có thể truyền từ nền tảng xuống studio, tác giả và trợ lý.

Có thể hình dung:

```text
lịch phát hành cố định
→ thời gian sản xuất hữu hạn
→ khối lượng việc được chia cho nhóm
→ phụ thuộc giữa các công đoạn tăng
→ chậm một bước có thể dồn áp lực sang bước sau
```
...
Biên đạo tạo cấu trúc chuyển động; vũ công biến cấu trúc đó thành hình ảnh trên sân khấu. Nhưng thương hiệu công chúng thường tập trung vào nghệ sĩ chính.

Điều này tạo câu hỏi về **ghi công (credit)**, **quyền sử dụng tác phẩm**, mức thù lao và khả năng người sáng tạo tích luỹ danh tiếng nghề nghiệp. Một đoạn vũ đạo có thể lan truyền toàn cầu trong khi phần lớn khán giả không biết ai đã thiết kế nó.

Vì vậy khi học văn hoá sáng tạo, cần phân biệt:

```text
ai xuất hiện trước công chúng?
ai tạo thành phần sáng tạo?
ai giữ quyền khai thác?
ai nhận doanh thu?
```
...
Khi lịch phát hành gần đồng thời ở nhiều quốc gia, người dịch có thể làm dưới thời hạn ngắn. Chất lượng vì vậy phụ thuộc không chỉ năng lực cá nhân mà còn thời gian, tài liệu tham khảo, khả năng hỏi đội sản xuất và quy trình kiểm tra.

Toàn cầu hoá nội dung có một hạ tầng vô hình: **lao động ngôn ngữ**.
...
Không nên học bằng công thức “người sáng tạo luôn sở hữu mọi quyền” hoặc “công ty luôn sở hữu tất cả”. Điều đúng hơn là:
...
Một người có thể được ghi tên nhưng nhận thù lao cố định mà không có phần doanh thu sau đó. Người khác có thể nắm quyền tài sản hoặc quyền khai thác nhưng không xuất hiện trước công chúng. Một công ty có thể bỏ vốn và chịu rủi ro tài chính để đổi lấy quyền thương mại rộng hơn.
...
Khi phần lớn độc giả hoặc người xem tập trung ở một số nền tảng, người sáng tạo cần nền tảng để tiếp cận khán giả; nền tảng cần nội dung để giữ người dùng. Đây là quan hệ phụ thuộc hai chiều nhưng quyền thương lượng không nhất thiết cân bằng.

Các biến quan trọng gồm:

```text
quy mô khán giả của nền tảng
+ khả năng người sáng tạo chuyển sang nơi khác
+ quyền sở hữu IP
+ mức minh bạch dữ liệu
+ cấu trúc chia doanh thu
→ quyền thương lượng thực tế
```
...
Đây là **bất cân xứng thông tin (information asymmetry)**. Nếu một bên biết chính xác giá trị nội dung với hệ thống còn bên kia không biết, việc đàm phán giá trở nên khó cân bằng hơn.
...
Một phim, album hoặc webtoon có thể tạo doanh thu rất lớn. Nhưng câu hỏi phân phối vẫn riêng biệt:

```text
tổng doanh thu
- chi phí nền tảng / phát hành
- chi phí sản xuất / tiếp thị
- phần của nhà đầu tư / công ty
- các khoản theo hợp đồng
→ phần còn lại cho từng nhóm tham gia
```

Không thể suy thu nhập cá nhân từ doanh thu đầu bảng nếu không biết cấu trúc chi phí và hợp đồng.
...
Không nên đóng băng một kết luận pháp lý cụ thể trong chương văn hoá vì luật và hợp đồng tiếp tục thay đổi. Mô hình cần nhớ là:

```text
chi phí sao chép / biến đổi giảm
→ số trường hợp sử dụng tăng
→ nhu cầu xác thực nguồn gốc và quyền tăng
```
...
Nội dung văn hoá tạo **hiệu ứng lan toả (spillover / 파급효과)** sang ẩm thực, mỹ phẩm, du lịch và học ngôn ngữ. Khi người xem thấy món ăn trong phim, nhu cầu tìm kiếm có thể tăng; người nổi tiếng quảng bá sản phẩm có thể làm giảm bất định về thương hiệu.

Nhưng quan hệ nhân quả khó đo vì nhiều chiến dịch diễn ra đồng thời. Mức thiện cảm trong khảo sát chỉ là tương quan hoặc nhận thức, không phải bằng chứng rằng một bộ phim trực tiếp làm GDP tăng.

Một địa điểm quay phim cũng có thể trở thành điểm đến nhờ lớp ký ức kể chuyện:

```text
địa điểm vật lý
+ câu chuyện trên màn ảnh
+ ký ức người hâm mộ
→ điểm du lịch truyền thông
```
...
lớp sản xuất: công ty giải trí / studio / nhà xuất bản
lớp quyền: hợp đồng / copyright / quyền chuyển thể / ghi công
lớp phân phối: nền tảng / đài / rạp / nhà phát hành
...
“Tác phẩm thành công thì tất cả người làm ra nó đều kiếm được nhiều tiền” là sai; quyền, hợp đồng, chi phí và cách chia doanh thu quyết định phân phối giá trị.
