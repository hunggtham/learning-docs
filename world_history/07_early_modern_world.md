# 07 — Early modern world: thuốc súng, đại dương và nhà nước tài chính

Từ khoảng thế kỷ XV–XVIII, nhiều vùng đồng thời chứng kiến centralization, gunpowder empires, merchant capitalism, oceanic navigation, printing, agrarian commercialization và các cuộc khủng hoảng tôn giáo–chính trị.

```text
gunpowder + taxation + credit
→ army/navy và administration lớn hơn
→ port, plantation, silver và commodity chains
→ price/demographic shifts + religious/political contest
→ sovereignty và state capacity được tái định nghĩa
```

Technology không tự tạo “châu Âu thống trị”: ship design, wind knowledge, maps, finance và liên minh địa phương cùng quan trọng. Resources gồm bạc châu Mỹ, đất, đường, gia vị, nô lệ và ngũ cốc; trade tạo wealth đồng thời tạo coercion. Ideas gồm print publics, Reformation, legal debates, sovereignty, scientific inquiry và Indigenous diplomacy.

Đọc Ottoman, Safavid, Mughal, Ming/Qing, Tokugawa, Tây Phi, Đông Nam Á và châu Mỹ trong cùng một thế giới liên kết, không xem châu Âu là trung tâm mặc định.

## Cơ chế nhà nước tài chính

Gunpowder không tự tạo centralization. Nhà nước cần thuế ổn định, credit, arsenals, skilled officers, roads/ports và một thỏa thuận với landlord, merchant hoặc religious authority. Khi war cost tăng, sovereign có thể vay, bán office, farm thuế hoặc mở độc quyền; mỗi cách làm đổi legitimacy và phân phối surplus.

### Đại dương và silver flow

```text
mine/plantation → ship/insurance → port/merchant house
→ customs/credit → army/court/consumer market
→ inflation, land pressure, labor coercion
```

Silver nối châu Mỹ, châu Âu và châu Á nhưng không có nghĩa mọi vùng hội nhập bình đẳng. Một port có thể giàu nhờ re-export trong khi hinterland chịu thuế, mất đất hoặc thiếu lương thực. Bạc, đường, gia vị và grain cần được đọc đồng thời với slavery, Indigenous labor và ecological change.

### Print, science và public authority

In ấn giảm chi phí copy nhưng không đảm bảo truth; censorship, literacy, patronage và market quyết định text nào sống. Reformation, scientific societies và legal debates mở không gian phản biện, đồng thời tạo chiến tranh confession và phân cực mới.

## Câu hỏi kiểm tra

1. Vì sao một technology hàng hải tạo lợi thế ở port này nhưng không ở port khác?
