# World History — Master Knowledge Book
...
- Địa hình, khí hậu, tài nguyên, tuyến biển và không gian được nối sang [`world_geography/`](../world_geography/); geography là constraint và opportunity, không phải định mệnh.
- Trao đổi, tín dụng, năng lượng và phân phối giá trị có thể đọc cùng [`investing/`](../investing/) và các chapter economics liên quan.
- Nhà nước, luật, quyền công dân, thuộc địa và chủ quyền được đặt cạnh [`korea_law_civic_life/`](../korea_law_civic_life/) khi cần một case hiện đại.
- Tôn giáo, gia đình, giới, lao động, ký ức và đời sống thường ngày được đọc như institutions và social practices; không giản lược chúng thành “văn hoá” bất biến.

## Quy tắc đọc một giai đoạn

1. Xác định **scale**: hộ gia đình, thành phố, đế chế, đại dương hay hệ thống toàn cầu.
2. Vẽ các **stock/flow**: dân số, đất, nước, lương thực, bạc/vàng, năng lượng, hàng hoá, dữ liệu và nhân lực.
...
Mỗi chapter phân biệt nguồn sơ cấp, diễn giải sử học, số liệu dân số/kinh tế và suy luận của người đọc. Niên đại là mốc định hướng; causal claim phải nêu cơ chế, scale, độ bất định và counterfactual tối thiểu. Xem [phương pháp và connections](18_methods_connections.md), [glossary](19_glossary_and_reference_map.md) và [coverage audit](COVERAGE_AUDIT.md).
